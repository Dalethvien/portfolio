...
export default function About(){
    return(
    <div id="AboutMe" className="flex flex-col gap-10 h-screen scroll-mt-16 min-h-fit">
        <div className="flex flex-col gap-6 max-w-1/2">
            ...
            <p className="text-lg/9">
                ...
                j'apprécie d'autres jeux compétitifs tel que Valorant ou Teamfight Tactics. Sinon j'ai pour ambition de collecter les 202 fraises de Celeste !<br />
